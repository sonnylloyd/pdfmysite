...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.archives' => 'getSonata_Admin_ArchivesService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'pdfmysite', 'user' => 'postgres', 'password' => 'aIRLol123', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/PdfMySite/Bundle/FrontBundle/Entity'))), 'PdfMySite\\Bundle\\FrontBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('PdfMySiteFrontBundle' => 'PdfMySite\\Bundle\\FrontBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_842e5c98d2d34e213916e0bb04909d246978aee0512e9c8be1a7869b12f0d688');
    ...
    /**
     * Gets the 'presta_sitemap.dumper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Presta\SitemapBundle\Service\Dumper A Presta\SitemapBundle\Service\Dumper instance.
     */
    protected function getPrestaSitemap_DumperService()
    {
        return $this->services['presta_sitemap.dumper'] = new \Presta\SitemapBundle\Service\Dumper($this->get('debug.event_dispatcher'), $this->get('filesystem'), 'sitemap', 50000);
    }

    /**
     * Gets the 'presta_sitemap.eventlistener.route_annotation' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Presta\SitemapBundle\EventListener\RouteAnnotationEventListener A Presta\SitemapBundle\EventListener\RouteAnnotationEventListener instance.
     */
    ...
    /**
     * Gets the 'presta_sitemap.generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Presta\SitemapBundle\Service\Generator A Presta\SitemapBundle\Service\Generator instance.
     */
    protected function getPrestaSitemap_GeneratorService()
    {
        return $this->services['presta_sitemap.generator'] = new \Presta\SitemapBundle\Service\Generator($this->get('debug.event_dispatcher'), $this->get('router'), NULL, '3600', 50000);
    }
    ...
    /**
     * Gets the 'sonata.admin.archives' service.
     *
     * @return \PdfMySite\Bundle\AdminBundle\Admin\ArchivesAdmin A PdfMySite\Bundle\AdminBundle\Admin\ArchivesAdmin instance.
     */
    protected function getSonata_Admin_ArchivesService()
    {
        $instance = new \PdfMySite\Bundle\AdminBundle\Admin\ArchivesAdmin('sonata.admin.archives', 'PdfMySite\\Bundle\\FrontBundle\\Entity\\Archives', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('PdfMySiteFrontBundle');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.archives'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.archives'))));
        $instance->setAdminClasses(array('PdfMySite\\Bundle\\FrontBundle\\Entity\\Archives' => array(0 => 'sonata.admin.archives')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.archives'), $this);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PdfMySite/Bundle/FrontBundle/Resources/views'), 'PdfMySiteFront');
        $instance->addPath(($this->targetDirs[3].'/src/PdfMySite/Bundle/AdminBundle/Resources/views'), 'PdfMySiteAdmin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PdfMySiteAdminBundle' => 'PdfMySite\\Bundle\\AdminBundle\\PdfMySiteAdminBundle',
            ...
            'database_port' => 5432,
            'database_name' => 'pdfmysite',
            'database_user' => 'postgres',
            'database_password' => 'aIRLol123',
            ...
            'presta_sitemap.dumper_base_url' => 'http://www.pdfmysite.com/',
